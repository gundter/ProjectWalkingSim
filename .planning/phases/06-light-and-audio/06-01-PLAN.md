...
must_haves:
  ...
  artifacts:
    ...
    - path: "Source/ProjectWalkingSim/Public/Audio/AudioConstants.h"
      provides: "AudioConstants namespace with tuning values including FlashlightSuspicionScore"
...
Follow the same pattern as AIConstants in MonsterAITypes.h -- constexpr values in a namespace, no USTRUCT needed.
  ...
  <done>AudioConstants.h exists in Public/Audio/ with all tuning constants for Phase 6 systems, including FlashlightSuspicionScore for flashlight-to-AI detection tuning.</done>
</task>
...
4. AudioConstants::FlashlightSuspicionScore exists and equals 0.3f
5. FlashlightComponent creates SpotLight in BeginPlay (verify via log output)
</verification>

<success_criteria>
- FlashlightComponent.h/.cpp compile and create a narrow-cone spotlight on the player camera
- AudioConstants.h provides all tuning constants needed by Plans 02-05, including FlashlightSuspicionScore
