...
must_haves:
  truths:
    ...
    - "Blueprint subclasses exist for NarrativeTriggerActor, InspectableActor, ReadableActor and are placeable in levels"
    - "ReadableActor Blueprint has DocumentReaderWidgetClass assigned"
  artifacts:
    - path: "Content/Blueprints/UI/WBP_DocumentReader.uasset"
      provides: "UMG Blueprint reparented to UDocumentReaderWidget"
    - path: "Content/Blueprints/UI/WBP_TitleCard.uasset"
      provides: "Simple title card widget for demo ending"
    - path: "Content/Blueprints/Actors/BP_NarrativeTrigger.uasset"
      provides: "Blueprint subclass of ANarrativeTriggerActor"
    - path: "Content/Blueprints/Actors/BP_InspectableActor.uasset"
      provides: "Blueprint subclass of AInspectableActor"
    - path: "Content/Blueprints/Actors/BP_ReadableActor.uasset"
      provides: "Blueprint subclass of AReadableActor with DocumentReaderWidgetClass assigned"
  key_links:
...
Output: UMG widgets (WBP_DocumentReader, WBP_TitleCard), actor Blueprints (BP_NarrativeTrigger, BP_InspectableActor, BP_ReadableActor), and property assignments on existing Blueprints.
</objective>
...
<task type="checkpoint:human-action" gate="blocking">
  ...
  <action>
    ...
    **1. WBP_DocumentReader** (Content/Blueprints/UI/)
    ...
    **2. WBP_TitleCard** (Content/Blueprints/UI/)
    ...
    **3. Create BP_ReadableActor** (Content/Blueprints/Actors/)
    - BP_ReadableActor does NOT exist yet -- it MUST be created
    - Create Blueprint Class -> Parent: ReadableActor
    - Save as Content/Blueprints/Actors/BP_ReadableActor
    - Open Class Defaults, set `DocumentReaderWidgetClass` = WBP_DocumentReader
  </action>
  <how-to-verify>
    ...
    3. Open BP_ReadableActor, verify DocumentReaderWidgetClass = WBP_DocumentReader
    4. Compile all widget Blueprints -- no "missing BindWidget" errors
  </how-to-verify>
  <resume-signal>Type "widgets done" when all UMG Blueprints and BP_ReadableActor are created and compiled</resume-signal>
</task>
...
<task type="checkpoint:human-action" gate="blocking">
  ...
  <action>
    ...
    **1. BP_NarrativeTrigger** (Content/Blueprints/Actors/)
    - Create Blueprint Class -> Parent: NarrativeTriggerActor
    - Save as Content/Blueprints/Actors/BP_NarrativeTrigger
    ...
    **2. BP_InspectableActor** (Content/Blueprints/Actors/)
    - Create Blueprint Class -> Parent: InspectableActor
    - Save as Content/Blueprints/Actors/BP_InspectableActor
    ...
    **3. Create BP_DemoEndingTrigger** (Content/Blueprints/Actors/)
    - Create Blueprint Class -> Parent: NarrativeTriggerActor (reuse the trigger actor)
    - Save as Content/Blueprints/Actors/BP_DemoEndingTrigger
  ...
  <how-to-verify>
    ...
    3. BP_DemoEndingTrigger has a DemoEndingManager component with TitleCardWidgetClass = WBP_TitleCard
    4. BP_DemoEndingTrigger Event Graph has OnNarrativeTriggered -> TriggerEnding wiring
  </how-to-verify>
...
<success_criteria>
- WBP_DocumentReader, WBP_TitleCard exist as valid compiled UMG Blueprints in Content/Blueprints/UI/
- BP_NarrativeTrigger, BP_InspectableActor, BP_ReadableActor, BP_DemoEndingTrigger exist as valid compiled actor Blueprints in Content/Blueprints/Actors/
