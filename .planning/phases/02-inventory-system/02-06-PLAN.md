...
<objective>
Create input action assets, configure Asset Manager for item scanning, rebind interact key to F, and produce editor setup documentation for UMG Blueprints and data assets.
  ...
  <action>
    **Python script (Scripts/create_phase2_assets.py):**
    ...
    3. Rebind IA_Interact from E to F:
       ...
       - Actually, looking at the Phase 1 script notes: IA_Interact is bound to E with a Pressed trigger, and IA_LeanRight is bound to E with a Hold trigger. Changing IA_Interact to F means:
